...
*Full derivations for Appendices A.5–A.7, C, and D are in the accompanying Extended Online Appendix (see title-page link). Appendix labels are non-consecutive (A, C, D) because they correspond to distinct extension topics developed at different points in the project; no "Appendix B" was omitted.*
